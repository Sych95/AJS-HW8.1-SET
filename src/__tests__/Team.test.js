...
test('Test convert Set-collection to Array', ()=>{
    ...
    let expected = [{name: 'Azmodan', type:'Daemon', level: 1, health: 100, attack: undefined, defence: undefined},{name: 'Triss', type:'Magician', level: 1, health: 100, attack: undefined, defence: undefined}];
